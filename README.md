...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kubernetes_asyncio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8154&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kubernetes_asyncio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `kubernetes_asyncio` available on your platform with:
